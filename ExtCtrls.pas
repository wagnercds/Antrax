...
uses Dialogs, Themes, Math, Constsp;
...
resourcestring
  ...
  clNameMaroon = 'Marron';
  clNameGreen = 'Verde';
  clNameOlive = 'Verde oliva';
  clNameNavy = 'Azul marinho';
  clNamePurple = 'Roxo';
  clNameTeal = 'Azul petróleo';
  clNameGray = 'Cinza';
  clNameSilver = 'Prateado';
  clNameRed = 'Vermelho';
  clNameLime = 'Verde limão';
  clNameYellow = 'Amarelo';
  clNameBlue = 'Azul';
  clNameFuchsia = 'Fúcsia';
  clNameAqua = 'Azul piscina';
  clNameWhite = 'Branco';
  clNameMoneyGreen = 'Verde dinheiro';
  clNameSkyBlue = 'Azul céu';
  clNameCream = 'Creme';
  clNameMedGray = 'Cinza médio';
